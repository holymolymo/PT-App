...
// ─────────────────────────────────────────────
{
  ...
  grammar: [
    ...
    {id:'u3g06', type:'rule', title:'Um Klärung bitten',
      rule:'Não percebi. (Ich habe nicht verstanden.) | Pode repetir? (Können Sie wiederholen?) | O que significa...? (Was bedeutet...?) | Como se diz...? (Wie sagt man...?) | Pode soletrar? (Können Sie buchstabieren?)',
      examples:['Desculpe, não percebi. Pode repetir? (Entschuldigung, ich habe nicht verstanden. Können Sie wiederholen?)','O que significa "saudade"? (Was bedeutet "saudade"?)','Como se diz "Entschuldigung" em português? (Wie sagt man "Entschuldigung" auf PT?)','Mais devagar, por favor. (Langsamer, bitte.)'],
      note:'Diese Sätze sind deine RETTUNGSLEINE! Lerne sie als Erstes auswendig. "Não percebi" ist höflicher als "não entendo" (ich verstehe nicht). "Perceber" ist das Standardverb für "verstehen" im EU-PT.'},
  ]
},
...
// ─────────────────────────────────────────────
{
  ...
  grammar: [
    ...
    {id:'u5g10', type:'conjugation', title:'Reflexives Verb: levantar-se (Presente)',
      verb:'levantar-se', tense:'presente',
      forms:{'eu':'levanto-me','tu':'levantas-te','ele/ela/você':'levanta-se','nós':'levantamo-nos','eles/elas/vocês':'levantam-se'},
      note:'levantar-se = aufstehen. Muster für ALLE reflexiven Verben! Das Pronomen steht NACH dem Verb mit Bindestrich. Bei Verneinung VOR: "Não me levanto cedo."'},
    {id:'u5g11', type:'conjugation', title:'Reflexives Verb: deitar-se (Presente)',
      verb:'deitar-se', tense:'presente',
      forms:{'eu':'deito-me','tu':'deitas-te','ele/ela/você':'deita-se','nós':'deitamo-nos','eles/elas/vocês':'deitam-se'},
      note:'deitar-se = sich hinlegen / ins Bett gehen. Gleiche Struktur wie levantar-se. "Deito-me às onze." = Ich gehe um elf ins Bett.'},
    {id:'u5g12', type:'conjugation', title:'Reflexives Verb: sentir-se (Presente)',
      verb:'sentir-se', tense:'presente',
      forms:{'eu':'sinto-me','tu':'sentes-te','ele/ela/você':'sente-se','nós':'sentimo-nos','eles/elas/vocês':'sentem-se'},
      note:'sentir-se = sich fühlen. Vokalwechsel e→i in der eu-Form! "Sinto-me bem." = Ich fühle mich gut. "Como te sentes?" = Wie fühlst du dich?'},
    {id:'u5g13', type:'rule', title:'Häufige reflexive Verben im Alltag',
      rule:'levantar-se (aufstehen) | deitar-se (hinlegen) | vestir-se (anziehen) | lavar-se (waschen) | sentar-se (setzen) | sentir-se (fühlen) | lembrar-se de (erinnern) | esquecer-se de (vergessen) | chamar-se (heißen)',
      examples:['Levanto-me às sete. (Ich stehe um 7 auf.)','Sento-me no sofá. (Ich setze mich aufs Sofa.)','Lembro-me de ti. (Ich erinnere mich an dich.)','Esqueci-me do nome! (Ich habe den Namen vergessen!)'],
      note:'Reflexive Verben sind im Portugiesischen VIEL häufiger als im Deutschen! "lembrar-se de" und "esquecer-se de" brauchen immer "de". Bei Verneinung: Pronomen VOR das Verb — "Não me lembro."'},
  ]
},
...
// ─────────────────────────────────────────────
{
  ...
  grammar: [
    ...
    {id:'u8g08', type:'rule', title:'Meinung ausdrücken',
      rule:'Acho que... (Ich denke...) | Na minha opinião... | Concordo (Stimme zu) | Não concordo | Parece-me que... (Es scheint mir...)',
      examples:['Acho que tens razão. (Ich denke, du hast Recht.)','Na minha opinião, Lisboa é bonita. (Meiner Meinung nach...)','Concordo contigo. (Ich stimme dir zu.)','Não concordo. (Ich stimme nicht zu.)','Parece-me que vai chover. (Es scheint mir, dass es regnen wird.)'],
      note:'"Acho que" ist DIE Standard-Meinungsformel im Portugiesischen — viel häufiger als "penso que" im Alltag. Lerne diese 5 Ausdrücke und du kannst in jeder Diskussion mitmachen!'},
    {id:'u8g09', type:'rule', title:'Pläne machen & verabreden',
...
// ─────────────────────────────────────────────
{
  ...
  grammar: [
    ...
    {id:'u10g07', type:'rule', title:'Indefinitpronomen & -begleiter',
      rule:'algum/a (irgendein) | nenhum/a (kein) | muito/a (viel) | pouco/a (wenig) | outro/a (anderer) | todo/a (jeder/alle) | tudo (alles) | cada (jeder einzelne)',
      examples:['Alguma pergunta? (Irgendeine Frage?)','Nenhum problema. (Kein Problem.)','Muitas pessoas falam inglês. (Viele Leute sprechen Englisch.)','Todos os dias. (Jeden Tag.)','Outra vez, por favor. (Noch einmal, bitte.)','Tudo bem? (Alles gut?)','Cada pessoa é diferente. (Jede Person ist anders.)'],
      note:'Achtung: "tudo" = alles (Pronomen, unveränderlich). "todo/toda/todos/todas" = jeder/alle (Begleiter, passt sich an!). "Tudo bem?" vs. "Todos estão bem?" — großer Unterschied!'},
    {id:'u10g08', type:'rule', title:'Relativpronomen "que" (der/die/das)',
      rule:'que = der/die/das/den/die — verbindet zwei Sätze',
      examples:['A pessoa que mora aqui é simpática. (Die Person, die hier wohnt, ist nett.)','O livro que comprei é interessante. (Das Buch, das ich gekauft habe, ist interessant.)','A cidade onde moro é bonita. (Die Stadt, wo ich wohne, ist schön.)','O restaurante que me recomendaste é ótimo. (Das Restaurant, das du mir empfohlen hast, ist super.)'],
      note:'"Que" ist das häufigste Relativpronomen — es ersetzt "der/die/das/den/die/dem" ALLE. Für Orte: "onde" (wo). Für Personen mit Präposition: "quem" (A pessoa com quem falei = Die Person, mit der ich sprach).'},
    {id:'u10g09', type:'rule', title:'Pretérito Perfeito Composto (ter + Partizip)',
      rule:'tenho/tens/tem/temos/têm + Partizip = wiederholte/andauernde Handlung bis jetzt',
      examples:['Tenho estudado muito. (Ich habe viel gelernt. = und lerne weiter)','Tem chovido muito. (Es hat viel geregnet. = und regnet immer wieder)','Temos ido ao cinema. (Wir sind ins Kino gegangen. = mehrmals, Muster)'],
      note:'ACHTUNG: Im EU-PT bedeutet "tenho feito" NICHT "ich habe gemacht" wie im Deutschen/Englischen! Es bedeutet "ich habe (wiederholt/immer wieder) gemacht bis jetzt". Für einmalige Vergangenheit: Perfeito Simples (fiz). Das ist ein SEHR häufiger Fehler!'},
    {id:'u10g10', type:'rule', title:'Pluralbildung: Regeln',
      rule:'-s (normal) | -es (Konsonant) | -ões/-ães/-ãos (von -ão) | -is (von -l) | -ns (von -m)',
      examples:['casa → casas (normal)','país → países (-s bleibt, Akzent nötig)','limão → limões (häufigste -ão Form)','pão → pães, irmão → irmãos, mão → mãos','animal → animais, hotel → hotéis','homem → homens, viagem → viagens'],
      note:'Die 3 Formen von -ão-Wörtern muss man leider auswendig lernen! Tipp: -ção-Wörter sind IMMER -ções (informação → informações). -ão bei Personen oft -ãos (irmão → irmãos).'},
  ]
},
...
// ─────────────────────────────────────────────
{
  ...
  grammar: [
    ...
    {id:'u11g11', type:'conjugation', title:'Perfeito unregelmäßig: poder',
      verb:'poder', tense:'perfeito',
      forms:{'eu':'pude','tu':'pudeste','ele/ela/você':'pôde','nós':'pudemos','eles/elas/vocês':'puderam'},
      note:'poder (können) im Perfekt. "Não pude ir" = Ich konnte nicht gehen. Achtung: pôde (er konnte) vs. pode (er kann) — Akzent macht den Unterschied!'},
    {id:'u11g12', type:'conjugation', title:'Perfeito unregelmäßig: querer',
      verb:'querer', tense:'perfeito',
      forms:{'eu':'quis','tu':'quiseste','ele/ela/você':'quis','nós':'quisemos','eles/elas/vocês':'quiseram'},
      note:'querer (wollen) im Perfekt. "Ela quis ir" = Sie wollte gehen. Komplett irregulärer Stamm: quis-.'},
    {id:'u11g13', type:'conjugation', title:'Perfeito unregelmäßig: saber',
      verb:'saber', tense:'perfeito',
      forms:{'eu':'soube','tu':'soubeste','ele/ela/você':'soube','nós':'soubemos','eles/elas/vocês':'souberam'},
      note:'saber (wissen) im Perfekt. "Soube ontem" = Ich habe es gestern erfahren. Im Perfekt bedeutet saber oft "erfahren/herausfinden".'},
    {id:'u11g14', type:'conjugation', title:'Perfeito unregelmäßig: trazer',
      verb:'trazer', tense:'perfeito',
      forms:{'eu':'trouxe','tu':'trouxeste','ele/ela/você':'trouxe','nós':'trouxemos','eles/elas/vocês':'trouxeram'},
      note:'trazer (bringen/mitbringen) im Perfekt. "Trouxe um presente" = Ich habe ein Geschenk mitgebracht. Komplett anderer Stamm: troux-.'},
    {id:'u11g15', type:'conjugation', title:'Perfeito unregelmäßig: pôr',
      verb:'pôr', tense:'perfeito',
      forms:{'eu':'pus','tu':'puseste','ele/ela/você':'pôs','nós':'pusemos','eles/elas/vocês':'puseram'},
      note:'pôr (setzen/stellen/legen) im Perfekt. "Pus na mesa" = Ich habe es auf den Tisch gestellt. Stamm: pus-.'},
    {id:'u11g16', type:'conjugation', title:'Perfeito unregelmäßig: haver',
      verb:'haver', tense:'perfeito',
      forms:{'eu':'houve','tu':'houveste','ele/ela/você':'houve','nós':'houvemos','eles/elas/vocês':'houveram'},
      note:'haver (geben/existieren) im Perfekt. Meist unpersönlich: "Houve um acidente" = Es gab einen Unfall. "Houve muita gente" = Es waren viele Leute da.'},
    {id:'u11g17', type:'rule', title:'Pronomenstellung: enclisis vs. proclisis',
...
// ─────────────────────────────────────────────
{
  ...
  grammar: [
    ...
    {id:'u14g07', type:'conjugation', title:'Conjuntivo Presente: ser',
      verb:'ser', tense:'conjuntivo presente',
      forms:{'eu':'seja','tu':'sejas','ele/ela/você':'seja','nós':'sejamos','eles/elas/vocês':'sejam'},
      note:'Conjuntivo von ser. Auswendig lernen! Kommt nach: que, talvez, espero que, quero que, embora. "Espero que sejas feliz." = Ich hoffe, du bist glücklich.'},
    {id:'u14g08', type:'conjugation', title:'Conjuntivo Presente: estar',
      verb:'estar', tense:'conjuntivo presente',
      forms:{'eu':'esteja','tu':'estejas','ele/ela/você':'esteja','nós':'estejamos','eles/elas/vocês':'estejam'},
      note:'Conjuntivo von estar. "Espero que esteja bem." = Ich hoffe, es geht Ihnen gut. Eine der häufigsten Konjunktiv-Formen im Alltag!'},
    {id:'u14g09', type:'conjugation', title:'Conjuntivo Presente: ter',
      verb:'ter', tense:'conjuntivo presente',
      forms:{'eu':'tenha','tu':'tenhas','ele/ela/você':'tenha','nós':'tenhamos','eles/elas/vocês':'tenham'},
      note:'"Talvez tenha razão." = Vielleicht hat er Recht. "É preciso que tenhamos paciência." = Wir müssen Geduld haben.'},
    {id:'u14g10', type:'conjugation', title:'Conjuntivo Presente: ir',
      verb:'ir', tense:'conjuntivo presente',
      forms:{'eu':'vá','tu':'vás','ele/ela/você':'vá','nós':'vamos','eles/elas/vocês':'vão'},
      note:'"Espero que vá correr bem." = Ich hoffe, es läuft gut. Achtung: nós/eles-Formen sind identisch mit dem Indikativ!'},
    {id:'u14g11', type:'conjugation', title:'Conjuntivo Presente: fazer',
      verb:'fazer', tense:'conjuntivo presente',
      forms:{'eu':'faça','tu':'faças','ele/ela/você':'faça','nós':'façamos','eles/elas/vocês':'façam'},
      note:'"Quero que faças o trabalho." = Ich will, dass du die Arbeit machst. Der Konjunktiv drückt Wunsch, Zweifel oder Notwendigkeit aus.'},
    {id:'u14g12', type:'rule', title:'Konjunktiv — Wann? (Trigger-Wörter)',
      rule:'que (nach Wunsch/Gefühl) | talvez (vielleicht) | embora (obwohl) | antes que (bevor) | para que (damit) | sem que (ohne dass)',
      examples:['Quero que venhas. (Ich will, dass du kommst.)','Talvez faça sol amanhã. (Vielleicht scheint morgen die Sonne.)','Embora esteja cansado, vou sair. (Obwohl ich müde bin, gehe ich raus.)','Vou embora antes que chova. (Ich gehe bevor es regnet.)'],
      note:'Faustregel: Nach "que" steht Konjunktiv, wenn der Hauptsatz einen Wunsch, ein Gefühl, eine Meinung oder Unsicherheit ausdrückt. Nach Fakten steht Indikativ: "Sei que tens razão" (Ich weiß, dass du Recht hast — sicher = Indikativ).'},
    {id:'u14g13', type:'rule', title:'Persönlicher Infinitiv — Konjugation',
      rule:'Infinitiv + -/-es/-/-mos/-em: falar, falares, falar, falarmos, falarem',
      examples:['É importante estudarmos. (Es ist wichtig, dass wir lernen.)','Antes de eles saírem... (Bevor sie gingen...)','Para nós entendermos. (Damit wir verstehen.)','Sem eles saberem. (Ohne dass sie es wissen.)'],
      note:'Der persönliche Infinitiv existiert NUR im Portugiesisch und Galicisch — einzigartig weltweit! Er ersetzt oft den Konjunktiv und ist im EU-PT sehr häufig. Bildung: normaler Infinitiv + Personalendung (-es für tu, -mos für nós, -em für eles).'},
  ]
}
