  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c1n2',speaker:'learner',type:'choose',prompt:'Bestelle einen Kaffee',
        options:[
          {pt:'Uma bica, por favor.',correct:true,next:'c1n3'},
          {pt:'Quero um bolo.',correct:false,feedback:'Fast! Aber du wolltest doch einen Kaffee bestellen.',next:'c1n2'},
          {pt:'Nada, obrigado.',correct:false,feedback:'Du wolltest doch etwas bestellen!',next:'c1n2'}
        ],next:'c1n3'},
      ...
      {id:'c1n8',speaker:'learner',type:'write',prompt:'Bedanke dich',
        ...
        answer:'Muito obrigado!',next:'c1n9'},
      {id:'c1n9',speaker:'npc',type:'say',pt:'De nada! Tenha um bom dia!',de:'Gern geschehen! Schönen Tag noch!',next:'end'},
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c2n3',speaker:'learner',type:'choose',prompt:'Frage, ob es weit ist',
        options:[
          {pt:'Fica longe daqui?',correct:true,next:'c2n4'},
          {pt:'É grande?',correct:false,feedback:'"É grande" heißt "ist es groß". Du möchtest fragen, ob es weit ist: "Fica longe?"',next:'c2n3'},
          {pt:'Quanto tempo demora de carro?',correct:false,feedback:'Du bist zu Fuß unterwegs! Frage lieber "Fica longe daqui?" — ob es weit von hier ist.',next:'c2n3'},
        ],next:'c2n4'},
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c3n2',speaker:'learner',type:'choose',prompt:'Sag, dass du eine Reservierung hast',
        options:[
          {pt:'Boa tarde! Tenho uma reserva.',correct:true,next:'c3n3'},
          {pt:'Quero um quarto.',correct:false,feedback:'Nicht falsch, aber du hast doch schon reserviert! Sag "Tenho uma reserva".',next:'c3n2'},
          {pt:'Boa tarde! Posso ver o menu?',correct:false,feedback:'Du bist im Hotel, nicht im Restaurant! Sage "Tenho uma reserva" — ich habe eine Reservierung.',next:'c3n2'},
        ],next:'c3n3'},
      ...
      {id:'c3n6',speaker:'learner',type:'choose',prompt:'Frage nach dem WLAN-Passwort',
        options:[
          {pt:'Qual é a senha do Wi-Fi?',correct:true,next:'c3n7'},
          {pt:'Tem internet?',correct:false,feedback:'Gut gedacht, aber frage direkt nach dem Passwort: "Qual é a senha do Wi-Fi?"',next:'c3n6'},
          {pt:'Onde posso comprar internet?',correct:false,feedback:'Das WLAN ist im Hotel kostenlos! Frage einfach nach dem Passwort: "Qual é a senha do Wi-Fi?"',next:'c3n6'},
        ],next:'c3n7'},
      ...
      {id:'c3n8',speaker:'learner',type:'write',prompt:'Bedanke dich',
        keywords:['obrigad','muito','agradeç'],hint:'Muito...',
        answer:'Muito obrigado!',next:'c3n9'},
      {id:'c3n9',speaker:'npc',type:'say',pt:'De nada! Se precisar de alguma coisa, estamos na receção. Boa estadia!',de:'Gern geschehen! Wenn Sie etwas brauchen, wir sind an der Rezeption. Schönen Aufenthalt!',next:'end'},
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c4n4',speaker:'learner',type:'choose',prompt:'Sag, dass du aus Deutschland kommst',
        options:[
          {pt:'Sou da Alemanha.',correct:true,next:'c4n5'},
          {pt:'Moro na Alemanha.',correct:false,feedback:'Nicht falsch! Aber "Sou da Alemanha" ist die natürlichere Antwort auf "De onde és?"',next:'c4n4'},
          {pt:'Venho de Berlim hoje.',correct:false,feedback:'"Venho de Berlim hoje" heißt "ich komme heute aus Berlin" — das klingt wie eine Reisebeschreibung. Sage einfach "Sou da Alemanha".',next:'c4n4'},
        ],next:'c4n5'},
      ...
      {id:'c4n6',speaker:'learner',type:'choose',prompt:'Antworte begeistert',
        options:[
          {pt:'Sim, adoro! Portugal é muito bonito.',correct:true,next:'c4n7'},
          {pt:'Sim, está bem.',correct:false,feedback:'Etwas mehr Begeisterung! Versuch "Sim, adoro!"',next:'c4n6'},
          {pt:'Sim, a comida é boa.',correct:false,feedback:'Das Essen ist gut, aber zeige mehr Begeisterung für das ganze Land! "Sim, adoro! Portugal é muito bonito."',next:'c4n6'},
        ],next:'c4n7'},
      ...
      {id:'c4n8',speaker:'learner',type:'write',prompt:'Sag, seit wie vielen Tagen du da bist (z.B. "Estou aqui há três dias")',
        ...
        answer:'Estou aqui há três dias.',next:'c4n9'},
      {id:'c4n9',speaker:'npc',type:'say',pt:'Que bom! Espero que aproveites bem a estadia. Bem-vindo!',de:'Wie schön! Ich hoffe, du genießt den Aufenthalt. Willkommen!',next:'end'},
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c5n2',speaker:'learner',type:'choose',prompt:'Sag, dass du dich nicht gut fühlst',
        options:[
          {pt:'Não me sinto muito bem. Dói-me a cabeça.',correct:true,next:'c5n3'},
          {pt:'Estou doente.',correct:false,feedback:'Gut, aber sei genauer! Was tut weh? Versuch "Dói-me a cabeça".',next:'c5n2'},
          {pt:'Tenho dores nas costas.',correct:false,feedback:'Rückenschmerzen? Du hast doch Kopfschmerzen! "Dói-me a cabeça" = Mir tut der Kopf weh.',next:'c5n2'},
        ],next:'c5n3'},
      ...
      {id:'c5n6',speaker:'learner',type:'choose',prompt:'Antworte: kein Fieber, aber allergisch gegen Penicillin',
        options:[
          {pt:'Não tenho febre, mas sou alérgico a penicilina.',correct:true,next:'c5n7'},
          {pt:'Não sei.',correct:false,feedback:'Wichtig beim Arzt: Allergien immer nennen! "Sou alérgico/a a..."',next:'c5n6'},
          {pt:'Tenho um pouco de febre.',correct:false,feedback:'Du hast kein Fieber! Sage "Não tenho febre" und erwähne deine Penicillin-Allergie.',next:'c5n6'},
        ],next:'c5n7'},
      ...
      {id:'c5n8',speaker:'learner',type:'write',prompt:'Bedanke dich beim Arzt',
        ...
        answer:'Muito obrigado, doutor!',next:'c5n9'},
      {id:'c5n9',speaker:'npc',type:'say',pt:'De nada! As melhoras. Se não melhorar em três dias, volte cá.',de:'Gern geschehen! Gute Besserung. Wenn es in drei Tagen nicht besser wird, kommen Sie wieder.',next:'end'},
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c6n2',speaker:'learner',type:'choose',prompt:'Frage, wo man Obst findet',
        options:[
          {pt:'Sim, onde posso encontrar fruta?',correct:true,next:'c6n3'},
          {pt:'Quero comprar coisas.',correct:false,feedback:'Sei etwas genauer! Frage nach dem, was du suchst: "Onde posso encontrar...?"',next:'c6n2'},
          {pt:'Onde fica o pão?',correct:false,feedback:'Du suchst Obst (fruta), nicht Brot (pão)! Frage "Onde posso encontrar fruta?"',next:'c6n2'},
        ],next:'c6n3'},
      ...
      {id:'c6n6',speaker:'learner',type:'choose',prompt:'Sage, dass du keine Tüte brauchst und mit Karte zahlst',
        options:[
          {pt:'Não, obrigado. Posso pagar com cartão?',correct:true,next:'c6n7'},
          {pt:'Sim, um saco.',correct:false,feedback:'Du hast einen eigenen Beutel dabei! Sag "Não, obrigado".',next:'c6n6'},
          {pt:'Não, obrigado. Pago em dinheiro.',correct:false,feedback:'Du wolltest doch mit Karte zahlen! "Posso pagar com cartão?" = Kann ich mit Karte zahlen?',next:'c6n6'},
        ],next:'c6n7'},
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c7n2',speaker:'learner',type:'choose',prompt:'Sage, dass du einen Termin vereinbaren möchtest',
        options:[
          {pt:'Bom dia! Queria marcar uma consulta, por favor.',correct:true,next:'c7n3'},
          {pt:'Olá, preciso de médico.',correct:false,feedback:'Auf Portugiesisch sagt man "marcar uma consulta" für "einen Termin vereinbaren".',next:'c7n2'},
          {pt:'Bom dia! Queria cancelar uma consulta.',correct:false,feedback:'"Cancelar" heißt absagen! Du möchtest einen Termin machen: "marcar uma consulta".',next:'c7n2'},
        ],next:'c7n3'},
      ...
      {id:'c7n6',speaker:'learner',type:'choose',prompt:'Wähle den Termin um 10 Uhr',
        options:[
          {pt:'Às dez horas, por favor.',correct:true,next:'c7n7'},
          {pt:'Às catorze.',correct:false,feedback:'Du wolltest den Morgentermin wählen! "Às dez horas".',next:'c7n6'},
          {pt:'Pode ser às doze?',correct:false,feedback:'Zwölf Uhr wurde nicht angeboten! Wähle einen der vorgeschlagenen Termine: "Às dez horas" oder "Às catorze".',next:'c7n6'},
        ],next:'c7n7'},
      ...
      {id:'c7n8',speaker:'learner',type:'write',prompt:'Gib deinen Namen an',
        ...
        answer:'O meu nome é Schmidt.',next:'c7n9'},
      {id:'c7n9',speaker:'npc',type:'say',pt:'Muito bem, senhor Schmidt. Fica marcado! Até terça-feira.',de:'Sehr gut, Herr Schmidt. Ist eingetragen! Bis Dienstag.',next:'end'},
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c8n2',speaker:'learner',type:'choose',prompt:'Das Essen ist kalt. Beschwere dich höflich',
        options:[
          {pt:'Desculpe, mas a comida está fria.',correct:true,next:'c8n3'},
          {pt:'A comida é horrível!',correct:false,feedback:'Lieber höflicher! Auf Portugiesisch bleibt man diplomatisch. Versuch "Desculpe, mas..."',next:'c8n2'},
          {pt:'Desculpe, falta o sal.',correct:false,feedback:'Das Problem ist nicht das Salz — das Essen ist kalt! Sage "a comida está fria".',next:'c8n2'},
        ],next:'c8n3'},
      ...
      {id:'c8n6',speaker:'learner',type:'choose',prompt:'Sag, dass jetzt alles gut ist',
        options:[
          {pt:'Não faz mal. Agora está perfeito, obrigado!',correct:true,next:'end'},
          {pt:'Está bem.',correct:false,feedback:'Etwas freundlicher! "Não faz mal" zeigt, dass du nicht böse bist.',next:'c8n6'},
          {pt:'Ainda não está bom.',correct:false,feedback:'Das neue Gericht ist gut! Sage höflich "Não faz mal. Agora está perfeito!"',next:'c8n6'},
        ],next:'end'},
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c9n2',speaker:'learner',type:'choose',prompt:'Sage ja und frage nach dem Preis der Orangen',
        options:[
          {pt:'Sim, por favor! Quanto custam as laranjas?',correct:true,next:'c9n3'},
          {pt:'Não, obrigado.',correct:false,feedback:'Komm, probier mal! Frage "Quanto custam as laranjas?"',next:'c9n2'},
          {pt:'Sim! Quanto custam as bananas?',correct:false,feedback:'Du wolltest nach Orangen (laranjas) fragen, nicht nach Bananen!',next:'c9n2'},
        ],next:'c9n3'},
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c10n2',speaker:'learner',type:'choose',prompt:'Sage, dass es dir gut geht und frage zurück',
        options:[
          {pt:'Olá! Tenho estado bem, obrigado. E tu?',correct:true,next:'c10n3'},
          {pt:'Olá.',correct:false,feedback:'Etwas mehr! Erzähl, wie es dir geht: "Tenho estado bem".',next:'c10n2'},
          {pt:'Olá! Estou muito ocupado.',correct:false,feedback:'Antworte erst auf die Frage! "Tenho estado bem" und frage auch zurück: "E tu?"',next:'c10n2'},
        ],next:'c10n3'},
      ...
      {id:'c10n4',speaker:'learner',type:'choose',prompt:'Nimm die Einladung an',
        options:[
          {pt:'Claro que sim! Que boa ideia!',correct:true,next:'c10n5'},
          {pt:'Talvez.',correct:false,feedback:'Sei etwas enthusiastischer! "Claro que sim!" = Natürlich!',next:'c10n4'},
          {pt:'Sim, mas prefiro almoço.',correct:false,feedback:'Die Einladung ist zum Abendessen (jantar) am Freitag! Nimm sie einfach an: "Claro que sim!"',next:'c10n4'},
        ],next:'c10n5'},
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c11n2',speaker:'learner',type:'choose',prompt:'Du hast Kopfschmerzen. Frage nach einem Mittel.',
        options:[
          {pt:'Tem alguma coisa para dores de cabeça?',correct:true,next:'c11n3'},
          {pt:'Dói-me a cabeça.',correct:false,feedback:'Gut formuliert, aber in der Apotheke fragst du besser direkt: "Tem alguma coisa para...?" — das ist die Standardfrage!',next:'c11n2'},
          {pt:'Tem alguma coisa para dores de estômago?',correct:false,feedback:'Magenschmerzen (dores de estômago)? Du hast doch Kopfschmerzen! "Dores de cabeça" = Kopfschmerzen.',next:'c11n2'},
        ],next:'c11n3'},
      ...
      {id:'c11n4',speaker:'learner',type:'choose',prompt:'Sage, dass du keine Allergien hast und frage nach der Einnahme',
        options:[
          {pt:'Não, nenhuma alergia. Como é que se toma?',correct:true,next:'c11n5'},
          {pt:'Não.',correct:false,feedback:'Frage auch gleich nach der Einnahme! "Como é que se toma?" = Wie nimmt man das ein?',next:'c11n4'},
          {pt:'Sim, sou alérgico a aspirina.',correct:false,feedback:'Du hast keine Allergien! Sage "Não, nenhuma alergia" und frage nach der Einnahme.',next:'c11n4'},
        ],next:'c11n5'},
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c12n2',speaker:'learner',type:'choose',prompt:'Bestätige und frage nach der Miete',
        options:[
          {pt:'Sim! Quanto é a renda mensal?',correct:true,next:'c12n3'},
          {pt:'Sim, quero ver.',correct:false,feedback:'Gut, aber frage gleich nach der Miete! "Quanto é a renda mensal?" ist die wichtigste Frage.',next:'c12n2'},
          {pt:'Sim! Quanto custa comprar o apartamento?',correct:false,feedback:'Du willst mieten, nicht kaufen! "A renda mensal" = die monatliche Miete.',next:'c12n2'},
        ],next:'c12n3'},
      ...
      {id:'c12n6',speaker:'learner',type:'choose',prompt:'Frage nach der Kaution und dem Vertrag',
        options:[
          {pt:'E a fiança? Qual é o prazo do contrato?',correct:true,next:'c12n7'},
          {pt:'Está bem.',correct:false,feedback:'Frage lieber nach den wichtigen Details! "A fiança" (Kaution) und "o prazo do contrato" (Vertragslaufzeit).',next:'c12n6'},
          {pt:'Posso mudar a decoração?',correct:false,feedback:'Erst die wichtigen Details klären! Frage nach Kaution und Vertrag: "E a fiança? Qual é o prazo do contrato?"',next:'c12n6'},
        ],next:'c12n7'},
      ...
      {id:'c12n8',speaker:'learner',type:'write',prompt:'Sage, dass dir die Wohnung gefällt und du interessiert bist',
        ...
        answer:'Gosto muito do apartamento. Estou interessado!',next:'c12n9'},
      {id:'c12n9',speaker:'npc',type:'say',pt:'Ótimo! Então envio-lhe o contrato por e-mail. Bem-vindo ao bairro!',de:'Super! Dann schicke ich Ihnen den Vertrag per E-Mail. Willkommen im Viertel!',next:'end'},
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c13n4',speaker:'learner',type:'choose',prompt:'Du hast einen Koffer aufzugeben',
        options:[
          {pt:'Sim, tenho uma mala para despachar.',correct:true,next:'c13n5'},
          {pt:'Não, só tenho bagagem de mão.',correct:false,feedback:'Du hast doch einen Koffer dabei! "Uma mala para despachar" = ein Koffer zum Aufgeben.',next:'c13n4'},
          {pt:'Sim, tenho três malas.',correct:false,feedback:'Du hast nur einen Koffer! "Uma mala para despachar" = ein Koffer zum Aufgeben.',next:'c13n4'},
        ],next:'c13n5'},
      ...
      {id:'c13n6',speaker:'learner',type:'choose',prompt:'Du möchtest am Fenster sitzen',
        options:[
          {pt:'À janela, por favor.',correct:true,next:'c13n7'},
          {pt:'No corredor, por favor.',correct:false,feedback:'Du wolltest doch am Fenster sitzen! "À janela" = am Fenster.',next:'c13n6'},
          {pt:'Na saída de emergência, por favor.',correct:false,feedback:'Du wolltest am Fenster sitzen! "À janela" = am Fenster, nicht beim Notausgang.',next:'c13n6'},
        ],next:'c13n7'},
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c14n2',speaker:'learner',type:'choose',prompt:'Du hast keinen Termin, fragst ob es ohne geht',
        options:[
          {pt:'Não, não tenho. É possível sem marcação?',correct:true,next:'c14n3'},
          {pt:'Sim.',correct:false,feedback:'Du hast keinen Termin! Sage "Não, não tenho" und frage ob es ohne geht.',next:'c14n2'},
          {pt:'Não sei. Talvez tenha marcação.',correct:false,feedback:'Du weißt doch, dass du keinen Termin hast! Sage klar "Não, não tenho. É possível sem marcação?"',next:'c14n2'},
        ],next:'c14n3'},
      ...
      {id:'c14n4',speaker:'learner',type:'choose',prompt:'Du möchtest die Haare schneiden lassen — nur kürzer',
        options:[
          {pt:'Queria cortar o cabelo, por favor. Só um pouco mais curto.',correct:true,next:'c14n5'},
          {pt:'Quero pintar o cabelo.',correct:false,feedback:'Du wolltest doch schneiden! "Cortar o cabelo" = Haare schneiden.',next:'c14n4'},
          {pt:'Queria lavar o cabelo, por favor.',correct:false,feedback:'Waschen reicht nicht — du willst schneiden! "Cortar o cabelo" = Haare schneiden.',next:'c14n4'},
        ],next:'c14n5'},
      ...
      {id:'c14n10',speaker:'learner',type:'write',prompt:'Zahle und verabschiede dich',
        ...
        answer:'Aqui tem. Muito obrigado!',next:'c14n11'},
      {id:'c14n11',speaker:'npc',type:'say',pt:'Obrigado eu! Tenha uma boa tarde!',de:'Ich danke Ihnen! Schönen Nachmittag!',next:'end'},
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      {id:'c15n1',speaker:'learner',type:'choose',prompt:'Du bist an der Haltestelle. Frage jemanden, ob das der richtige Bus nach Sintra ist',
        options:[
          {pt:'Desculpe, este autocarro vai para Sintra?',correct:true,next:'c15n2'},
          {pt:'Sintra?',correct:false,feedback:'Etwas ausführlicher! "Este autocarro vai para Sintra?" = Fährt dieser Bus nach Sintra?',next:'c15n1'},
          {pt:'Desculpe, onde posso apanhar o metro?',correct:false,feedback:'Du suchst den Bus nach Sintra, nicht die Metro! Frage "Este autocarro vai para Sintra?"',next:'c15n1'},
        ],next:'c15n2'},
      ...
      {id:'c15n6',speaker:'learner',type:'choose',prompt:'Kaufe ein Hin-und-Rück-Ticket nach Sintra',
        options:[
          {pt:'Um bilhete de ida e volta para Sintra, por favor.',correct:true,next:'c15n7'},
          {pt:'Um bilhete para Sintra.',correct:false,feedback:'Du willst hin UND zurück! "Ida e volta" = Hin und Zurück.',next:'c15n6'},
          {pt:'Dois bilhetes de ida para Sintra, por favor.',correct:false,feedback:'Du brauchst nicht zwei Tickets! Sage "Um bilhete de ida e volta" — ein Hin-und-Rück-Ticket.',next:'c15n6'},
        ],next:'c15n7'},
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c16n3',speaker:'learner',type:'choose',prompt:'Erkläre, dass die Waschmaschine kaputt ist',
        options:[
          {pt:'Na verdade, tenho um problema. A máquina de lavar está avariada.',correct:true,next:'c16n4'},
          {pt:'Sim, está tudo bem.',correct:false,feedback:'Du hast doch ein Problem! Sage "Tenho um problema" und erkläre was kaputt ist.',next:'c16n3'},
          {pt:'Tenho um problema. O frigorífico está avariado.',correct:false,feedback:'Der Kühlschrank (frigorífico)? Die Waschmaschine (máquina de lavar) ist kaputt!',next:'c16n3'},
        ],next:'c16n4'},
      ...
      {id:'c16n7',speaker:'learner',type:'choose',prompt:'Sage ja, morgen Vormittag passt dir',
        options:[
          {pt:'Sim, estou em casa amanhã de manhã. Obrigado!',correct:true,next:'c16n8'},
          {pt:'Não, amanhã não posso.',correct:false,feedback:'Morgen Vormittag passt dir doch! "Estou em casa amanhã de manhã."',next:'c16n7'},
          {pt:'Sim, mas prefiro à tarde.',correct:false,feedback:'Morgen Vormittag passt dir! Sage "Sim, estou em casa amanhã de manhã."',next:'c16n7'},
        ],next:'c16n8'},
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c17n2',speaker:'learner',type:'choose',prompt:'Sage, dass du Portugiesisch lernen möchtest',
        options:[
          {pt:'Boa tarde! Gostaria de me inscrever num curso de português.',correct:true,next:'c17n3'},
          {pt:'Quero falar português.',correct:false,feedback:'Höflicher! Benutze "Gostaria de me inscrever num curso de..." = Ich möchte mich für einen Kurs einschreiben.',next:'c17n2'},
          {pt:'Boa tarde! Gostaria de ensinar alemão.',correct:false,feedback:'"Ensinar" heißt unterrichten! Du möchtest Portugiesisch lernen, nicht Deutsch unterrichten. Sage "Gostaria de me inscrever num curso de português."',next:'c17n2'},
        ],next:'c17n3'},
      ...
      {id:'c17n6',speaker:'learner',type:'choose',prompt:'Frage nach dem Preis des normalen Kurses',
        options:[
          {pt:'Quanto custa o curso normal?',correct:true,next:'c17n7'},
          {pt:'Quero o intensivo.',correct:false,feedback:'Frage erst nach dem Preis! "Quanto custa o curso normal?"',next:'c17n6'},
          {pt:'Quanto custa o curso intensivo?',correct:false,feedback:'Du möchtest nach dem normalen Kurs fragen! "Quanto custa o curso normal?"',next:'c17n6'},
        ],next:'c17n7'},
      ...
      {id:'c17n10',speaker:'learner',type:'write',prompt:'Gib deinen Namen und sage, dass du deinen Reisepass dabei hast',
        ...
        answer:'O meu nome é Schmidt. Tenho o passaporte aqui.',next:'c17n11'},
      {id:'c17n11',speaker:'npc',type:'say',pt:'Perfeito! Está inscrito. Até segunda-feira então!',de:'Perfekt! Sie sind angemeldet. Bis Montag dann!',next:'end'},
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    nodes: [
      ...
      {id:'c18n2',speaker:'learner',type:'choose',prompt:'Sage, dass du dich informieren möchtest',
        options:[
          {pt:'Boa tarde! Gostaria de saber os preços e os horários.',correct:true,next:'c18n3'},
          {pt:'Quero ginásio.',correct:false,feedback:'Höflicher! "Gostaria de saber os preços e os horários" = Ich möchte die Preise und Zeiten erfahren.',next:'c18n2'},
          {pt:'Boa tarde! Quanto custa a piscina?',correct:false,feedback:'Du fragst nach dem Fitnessstudio (ginásio), nicht nach dem Schwimmbad (piscina)! Frage nach Preisen und Zeiten.',next:'c18n2'},
        ],next:'c18n3'},
      ...
      {id:'c18n6',speaker:'learner',type:'choose',prompt:'Sage ja und frage was du mitbringen musst',
        options:[
          {pt:'Sim, gostava! O que é que preciso de trazer?',correct:true,next:'c18n7'},
          {pt:'Não, obrigado.',correct:false,feedback:'Komm schon, probier es aus! "Sim, gostava!" = Ja, ich würde gerne!',next:'c18n6'},
          {pt:'Sim! Posso trazer um amigo?',correct:false,feedback:'Gute Idee, aber frage erst, was du mitbringen musst! "O que é que preciso de trazer?"',next:'c18n6'},
        ],next:'c18n7'},
